...
function setup() {
  ...
  boggie1= new Boggie(50,170,80,60);
  boggie2= new Boggie(150,170,80,60);
  boggie3= new Boggie(250,170,80,60);
  boggie4= new Boggie(350,170,80,60);
  boggie5= new Boggie(450,170,80,60);
  boggie6= new Boggie(550,170,80,60);
